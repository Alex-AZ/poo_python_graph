...
class Position:
    ...
    def __init__(self, longitude_degrees, latitude_degrees):
        ...
        # assert : Raises an exception if returns False
...
class Zone:
    ...
    be top-left and bottom-right, top right and bottom-left so you should be
    ...
    # Class attributes (constant if outside the class) because we do
    # cls.WIDTH_DEGREES
    ...
    # If there is an instance attribute, it goes into __init__
    ...
    def _initialize_zones(cls):
        # Note that is this method is "private": we prefix the method name with "_"
        cls.ZONES = []
...
def main():
    ...
    # Show graph. We pass in parameter the list of our zones to have access to them inside our class AgreeablenessGraph.
